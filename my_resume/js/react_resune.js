    ...
    project_info : [
	     {
	    	...
	    	times : '2019.4~2019.至今',
	    	values : [{
	    		info : '开发:根据原有项目,二次开发项目。',
	    	},{
	    		info : '完成状态: 迭代开发第二版等',
	    	}],
	    	describe : '使用公司：商业公司。',
    		...
    		id : '6',
    		projuct_name : 'E仝小程序工人端和服务端以及后台服务端',
    		name : '商业项目',
	    	job_position : 'Web前端开发',
	    	times : '2019.3~2019.4',
	    	values : [{
	    		info : '前期开发:熟悉小程序的需求功能等',
	    	},{
	    		info : '后期开发: 根据需求以及UI切图,实现页面布局以及动态交互。',
	    	},{
	    		info : '完成状态: 迭代开发第二版等',
	    	}],
	    	describe : '使用公司：商业公司。',
